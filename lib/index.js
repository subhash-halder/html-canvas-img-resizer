...
export default (function (options) {
    ...
    var _a = createContainer(options.id, dragCornerBoxSize), imageDiv = _a.imageDiv, exportCanvas = _a.exportCanvas, imageCanvas = _a.imageCanvas, cropCanvas = _a.cropCanvas, selectionDiv = _a.selectionDiv, bottomRightCornerDiv = _a.bottomRightCornerDiv, bottomLeftCornerDiv = _a.bottomLeftCornerDiv, topLeftCornerDiv = _a.topLeftCornerDiv, topRightCornerDiv = _a.topRightCornerDiv;
