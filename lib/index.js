...
export default (function (options) {
    ...
    var checkForContainerResizeMS = options.checkForContainerResizeMS === undefined
        ? 1000
    ...
    image.onload = function () {
        ...
        bottomLeftCornerDiv.addEventListener('touchstart', function () {
            dragBottomLeft = true;
        }, false);
        ...
        topLeftCornerDiv.addEventListener('touchstart', function () {
            dragTopLeft = true;
        }, false);
        ...
        topRightCornerDiv.addEventListener('touchstart', function () {
            dragTopRight = true;
        }, false);
        ...
        bottomRightCornerDiv.addEventListener('touchstart', function () {
            dragBottomRight = true;
        }, false);
        ...
        if (checkForContainerResizeMS > 0) {
            checkResizeFunction = window.setInterval(function () {
                ...
                if (preResizeState.canvasHeight != newHeight ||
                    ...
                    var xScale = preResizeState.canvasWidth > 0
                        ? newWidth / preResizeState.canvasWidth
                        : 0;
                    var yScale = preResizeState.canvasHeight > 0
